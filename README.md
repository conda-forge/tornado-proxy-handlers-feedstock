...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9813&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tornado-proxy-handlers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tornado-proxy-handlers` can be installed with:

```
conda install tornado-proxy-handlers
```

It is possible to list all of the versions of `tornado-proxy-handlers` available on your platform with:
